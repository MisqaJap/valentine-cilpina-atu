const CONFIG = {
  mainQuestion: "Sylvi, Will you be my Valentine? 💖",
  ...
  noEscapeTexts: [
    "Eits, ga iso😝",
    "Hehe, coba neh 😜",
    "Yowes deh, tak anggap YES ya! 💕",
  ],
  confirmTitle: "YEAAAY Kamu Beneran Mau 💗",
  confirmText: "Mulai dari sekarang kamu resmi jadi…",
  badgeText: "My Valentine",
  nextButton: "Lanjott ",
  repeatButton: "Baleni pertanyaan",
  flowerTitle: "Ini kado spesial buat kamu ",
  takeBouquetButton: "Terima hadiahnya ",
  bouquetMessage: "Yeayy Udah jadi milik kamu Cilpina Atuu 💕",
  nextFlowerButton: "Next ",
  collageTitle: "My Beautiful You",
  collageSubtitle:
    "Sejak kamu hadir, hal sederhana pun terasa istimewa. Happy Valentine, Sylvi Sayang!. 💕",
  nextCollageButton: "Satu halaman lagi… ",
  finalTitle: "Happy Valentine, My Calon Istri 💞",
  finalMessage: `Makasih ya sayangg sudah hadir dan bikin hariku selalu merasa kuat dan percaya diri. Kamu adalah alasan kenapa senyum aku itu mudah muncul. Semoga kamu adalah jodoh aku. Aku selalu ada untukmu. Happy Valentine Cilpina Atuu 💕`,
  restartButton: "Mbalen ",
  copyButton: "Copy Pesan ",
  copySuccess: "Cieeeee dicopy! ",
};
  ...
  if (state.musicPlaying) {
    ...
    audio
      ...
      .then(() => {
        ...
        icon.textContent = "⏸️"; // Ganti icon jadi pause saat main
      })
      .catch((error) => {
